 ...
 *
 */
package com.happyproject.aespa.ui.fragments.base

import android.os.Bundle
import com.happyproject.aespa.playback.TimberMusicService.Companion.MEDIA_CALLER
import com.happyproject.aespa.playback.TimberMusicService.Companion.MEDIA_ID_ARG
import com.happyproject.aespa.playback.TimberMusicService.Companion.MEDIA_TYPE_ARG
import com.happyproject.aespa.playback.TimberMusicService.Companion.TYPE_ALBUM
import com.happyproject.aespa.playback.TimberMusicService.Companion.TYPE_ALL_ALBUMS
import com.happyproject.aespa.playback.TimberMusicService.Companion.TYPE_ALL_PLAYLISTS
import com.happyproject.aespa.playback.TimberMusicService.Companion.TYPE_ALL_SONGS
import com.happyproject.aespa.playback.TimberMusicService.Companion.TYPE_GENRE
import com.happyproject.aespa.playback.TimberMusicService.Companion.TYPE_PLAYLIST
import com.happyproject.aespa.constants.Constants.ACTION_REMOVED_FROM_PLAYLIST
import com.happyproject.aespa.constants.Constants.ACTION_SONG_DELETED
import com.happyproject.aespa.constants.Constants.ALBUM
import com.happyproject.aespa.constants.Constants.CATEGORY_SONG_DATA
import com.happyproject.aespa.extensions.argumentOrEmpty
import com.happyproject.aespa.extensions.map
import com.happyproject.aespa.extensions.observe
import com.happyproject.aespa.models.CategorySongData
import com.happyproject.aespa.models.Genre
import com.happyproject.aespa.models.MediaID
import com.happyproject.aespa.models.Playlist
import com.happyproject.aespa.ui.fragments.PlaylistFragment
import com.happyproject.aespa.ui.fragments.album.AlbumDetailFragment
import com.happyproject.aespa.ui.fragments.album.AlbumsFragment
import com.happyproject.aespa.ui.fragments.songs.CategorySongsFragment
import com.happyproject.aespa.ui.fragments.songs.SongsFragment
import com.happyproject.aespa.ui.viewmodels.MediaItemFragmentViewModel
